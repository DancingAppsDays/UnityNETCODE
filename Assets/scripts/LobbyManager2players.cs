...
public class LobbyManager2players : MonoBehaviour
{//
   ...
   public async Task<Lobby>  CreateLobby(){
        ...
        CreateLobbyOptions options = new CreateLobbyOptions{
            ...
            //string cadenadeinicio =    await relayManager.CreateGame();
    ...
    public async  void ListLobbies(){
      ...
      public  void  JoinLobbybyList(int listvalue){

           
            JoinLobbyByCode( listalobbies[listvalue].LobbyCode);
